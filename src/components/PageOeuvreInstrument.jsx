...
import BoutonRechargeInstrument from './BoutonRechargeInstrument';
...
function entierAleatoire(min, max){
   ...
   const idRandomSelect = elementsInstruments[randomiseur];

class PageOeuvreInstrument extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            informations: {
...
export default PageOeuvreInstrument;
